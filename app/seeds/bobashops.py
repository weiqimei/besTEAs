...
def seed_bobashops():
    ...
    teaspoon = BobaShop(
        user_id=2, name="Teaspoon", image="https://s3-media0.fl.yelpcdn.com/bphoto/EUy5f36DcYO-6pHKP9zEtQ/o.jpg", address="25034 Hesperian Blvd", city="Hayward", state="CA", zipcode="94545", phone="(510) 274-5908", hours="11:00 AM - 10:00 PM")
    iTea = BobaShop(
